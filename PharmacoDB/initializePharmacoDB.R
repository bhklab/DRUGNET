...
tissue_match <- read.csv("matching_tissue.csv", na.strings = "", stringsAsFactor = FALSE)
lapply(studies, function (study) processCell (cells, study))
lapply(studies, function (study) processCellTissues (cells, study, tissue_match))
